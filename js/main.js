...
const sendEmail = function (e) {
	...
	if (subject === "") alert("subject is required !")
	else if (email === "") alert("Email is required !")
	else if (!validateEmail(email)) alert("Please provide a valid email !")
	else if (message === "") alert("Message is required !")
	else if (message.length < 10) alert("Message is too short !")
	else window.open(`mailto:jameem.mp@gmail.com?subject=${subject}&body=${message}`);
}
